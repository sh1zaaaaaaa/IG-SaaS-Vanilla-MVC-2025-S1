...
DROP USER IF EXISTS 'IG_SaaS_FED_2025_S1'@'localhost';
DROP USER IF EXISTS 'IG_SaaS_FED_2025_S1'@'127.0.0.1';


-- ---------------------------------------------------------------------------------------------
-- Create Database

CREATE DATABASE IF NOT EXISTS IG_SaaS_FED_2025_S1;
...
CREATE USER 'IG_SaaS_FED_2025_S1'@'localhost'
    IDENTIFIED BY 'Password1234';

CREATE USER 'IG_SaaS_FED_2025_S1'@'127.0.0.1'
    IDENTIFIED BY 'Password1234';

GRANT USAGE ON *.*
    TO 'IG_SaaS_FED_2025_S1'@'localhost';

GRANT USAGE ON *.*
    TO 'IG_SaaS_FED_2025_S1'@'127.0.0.1';

GRANT ALL PRIVILEGES
    ON `IG_SaaS_FED_2025_S1`.*
    TO 'IG_SaaS_FED_2025_S1'@'localhost';
...
-- ----------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `IG_SaaS_FED_2025_S1`.`users`;

-- ----------------------------------------------------------------------------------------
-- Table structure for 'users' table
-- ----------------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `IG_SaaS_FED_2025_S1`.`users`
(
...
-- ----------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `IG_SaaS_FED_2025_S1`.`products`;

-- ----------------------------------------------------------------------------------------
-- Create the Products table
-- ----------------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `IG_SaaS_FED_2025_S1`.`products`
(
...
-- Seed Products Table
-- ----------------------------------------------------------------------------------------
INSERT INTO `IG_SaaS_FED_2025_S1`.`products`(`id`, `user_id`, `name`, `description`, `price`, `created_at`)
